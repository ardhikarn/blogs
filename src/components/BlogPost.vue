    ...
    <div class="blog-content">
      <div>
        ...
        <router-link class="link link-light" to="#" v-if="post.welcomeScreen">
          Login/Register<ArrowRightLight class="arrow arrow-light" />
        </router-link>
        <router-link class="link" to="#" v-else>
          View The Post<ArrowRightLight class="arrow" />
        </router-link>
      </div>
    </div>
    <div class="blog-photo">
      <img v-if="post.welcomeScreen" :src="require(`../assets/blogPhotos/${post.photo}.jpg`)" :alt="post.photo" />
